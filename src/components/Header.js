...
export default function Header() {
  ...
  return (
    <header className="fixed z-40 w-full bg-gray-800">
      <nav
      ...
      >
        ...
        <a href="#" className="-m-1.5 p-1.5">
          <img className="h-6 w-auto" src="./images/logo.png" alt="t4me" />
        </a>
        <Popover.Group className="hidden lg:flex lg:gap-x-12 me-10">
